...
const areaSeedsSchema = new mongoose_1.Schema({
    Name: { type: String, required: true },
    Bins: { type: [BinSchema], required: true }
}, { collection: 'areabins' });
const AreaSeeds = mongoose_1.default.model('AreaSeeds', areaSeedsSchema);
exports.default = AreaSeeds;
//# sourceMappingURL=AreaSeeds.js.map